...
type
  ...
  SystemListIndexOf2 = class(TSystemListTest)
    function Execute: T; override;
  end;

  RapidListIndexOf2 = class(TRapidListTest)
    function Execute: T; override;
  end;
...
procedure InternalRun(const SystemTest, RapidTest: TTestClass; const IterationsCount: Integer);
begin
...
begin
  ...
  InternalRun(SystemListAdd, RapidListAdd, 300);
  InternalRun(SystemListAdd_Capacity, RapidListAdd_Capacity, 300);
  InternalRun(SystemListItems, RapidListItems, 1000);
  InternalRun(SystemListDelete, RapidListDelete, 500);
  InternalRun(SystemListIndexOf, RapidListIndexOf, 1000);
  InternalRun(SystemListIndexOf2, RapidListIndexOf2, 1000);
  InternalRun(SystemListReverse, RapidListReverse, 8000);
  InternalRun(SystemListPack, RapidListPack, 500);
  InternalRun(SystemStackPush, RapidStackPush, 300);
  InternalRun(SystemStackPush_Capacity, RapidStackPush_Capacity, 300);
  InternalRun(SystemStackPop, RapidStackPop, 500);
  InternalRun(SystemQueueEnqueue, RapidQueueEnqueue, 300);
